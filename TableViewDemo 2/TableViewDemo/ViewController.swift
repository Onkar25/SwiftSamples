...
class ViewController: UIViewController ,UITableViewDelegate,UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // To Add the Disclosure Arrow on the cell
        myTableViewCell.accessoryType = .disclosureIndicator // for >
        myTableViewCell.accessoryType = .checkmark      // for tick 
        myTableViewCell.accessoryType = .detailDisclosureButton  // for (i)> info Icon
        myTableViewCell.accessoryType = .detailButton // For (i)
